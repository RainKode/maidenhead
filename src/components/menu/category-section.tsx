...
export function CategorySection({ category, onSelectDish }: Props) {
  return (
    <section id={category.slug} className="scroll-mt-44">
      <div className="mb-5 flex flex-col gap-2 border-b border-ink/10 pb-5 md:flex-row md:items-end md:justify-between">
        <div>
        ...
        <p className="max-w-xl text-[15px] leading-relaxed text-ink/70 md:text-right">
          {category.blurb}
        </p>
      </div>
