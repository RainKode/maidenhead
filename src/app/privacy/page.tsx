...
export const metadata: Metadata = {
  ...
  description:
    "How Maidenhead Spice collects, uses and shares your personal information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="Privacy Policy"
      intro={
        "This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from this website (the “Site”)."
      }
    >
      ...
      <p>
        ...
        information, arranging for delivery, and providing you with invoices
        and/or order confirmations). Additionally, we use this Order
        Information to:
      </p>
      <ul>
        <li>
          Communicate with you, in particular changes to opening times and
          status of your order via email, phone or SMS;
        </li>
      ...
      <p>
        ...
        eTakeawayMax to help power our online store — read more about how they
        use your data at{" "}
        <a
          href="https://www.etakeawaymax.co.uk/privacy-policy/"
          target="_blank"
          rel="noreferrer"
        >
          etakeawaymax.co.uk/privacy-policy
        </a>
      ...
      <ul>
        ...
        <li>
          ...
          <a
            ...
            rel="noreferrer"
          >
            bingads.microsoft.com personalised ads policy
          </a>
        </li>
      </ul>
      <p>
